...
extend: 'Ext.panel.Panel',
        ...
        uploader: null,
                ...
                textBrowse: 'Выбор',
                textAbort: 'Отмена',
                textRemoveSelected: 'Убрать выбранные',
                textRemoveAll: 'Убрать все',
                // grid strings
                ...
                uploadMessageText: 'Прогресс загрузки {0}% ({1} из {2} файлов)',
                // browse button
                buttonText: 'Выбор...',
                button_browse_Tooltip:'Выбор файлов для добавления в список загрузки'
        },
        /**
        ...
        itemId: 'button_browse',
                ...
                button_browse_Tooltip: this.button_browse_Tooltip
        });
